...
public class OAuthActivity extends Activity implements OAuthCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebookButton.setOnClickListener(new View.OnClickListener() { // Listen the on click event
            ...
            public void onClick(View v)
            {
                isFB = true;
                isFitbit = false;
                oauth.popup("facebook", OAuthActivity.this); // Launch the pop up with the right provider & callback
            }
        });
        ...
        fitbitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                isFB = false;
                isFitbit = true;
                oauth.popup("fitbit", OAuthActivity.this); // Launch the pop up with the right provider & callback
            }
        });
    ...
    public void onFinished(OAuthData data) {
        ...
        if(isFitbit) {
            String url = "";
            data.http(url, new OAuthRequest() {
                @Override
